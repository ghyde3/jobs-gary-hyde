...
export const grafanaLabsSeniorAiEngineer: RoleData = {
  ...
  hero: {
    ...
    subhead:
      'A Claude API agent pipeline in production, multi-model code review tooling I built and use, and a daily workflow inside Claude Code and Cursor. The Senior AI Engineer role at Grafana Labs is the work I am already doing.',
  },
  ...
  note: [
    ...
    'my team uses, and I live inside Claude Code and Cursor. This is not a stretch into a new area for ' +
    'me. It is the center of my work right now.',

    'Pathara is the clearest proof. It is a job-search product where a candidate submits a resume and a ' +
    'short questionnaire, and a Claude API agent pipeline does the research and writing, returning ranked ' +
    ...
    'have built agent systems directly against the Claude API and the MCP model rather than through ' +
    'LangChain or CrewAI, so I would be learning your exact toolchain, not the underlying ideas. I would ' +
  ...
  requirements: [
    {
      ...
      proof:
        'I built Pathara, a production AI product where a Claude API agent pipeline takes a resume and a ' +
    ...
    {
      requirement:
        'Hands-on with the Anthropic Claude API, MCP, and multi-agent architectures.',
      proof:
        'I build agent systems directly against the Claude API. Pathara is a managed Claude agent pipeline ' +
    ...
    {
      requirement:
        'Fluent with AI coding agents like GitHub Copilot, Cursor, and Claude Code in daily work.',
      proof:
        'I work inside Claude Code and Cursor every day, not as a novelty but as how I build. I introduced ' +
  ...
  projects: [
    {
      ...
      framing:
        'Production AI agent pipeline: a Claude API agent takes a resume and questionnaire from intake to finished documents, with per-run cost and token telemetry. Built end to end in Next.js and TypeScript on Supabase.',
    },
    {
      projectTitle: 'Lumi',
      framing:
